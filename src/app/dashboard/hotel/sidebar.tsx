...
function AgencySidebar() {
  ...
  const menuItems = [
    { name: "Dashboard", icon: Home, href: "/dashboard/hotel" },
    { name: "Request", icon: ArrowDownUp, href: "/dashboard/hotel/request" },
    { name: "Help Desk", icon: HelpCircle, href: "/dashboard/hotel/helpdesk" },
  ];
