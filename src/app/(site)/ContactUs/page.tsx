...
const ContactUs = () => {
  ...
  return (
    <div className="pt-20 border-red-800">
      <div className="border-green-600 flex flex-col lg:flex-row justify-between px-4 md:px-8 lg:px-[5%] py-[5%]">
        ...
        <div className="w-full lg:w-[45%] border-red-700 h-auto lg:h-[770px] pt-[2%]">
          <h1 className="cinzel-font text-3xl md:text-5xl lg:text-[60px] font-[700] leading-[86.27px]">
            CONTACT US
          </h1>

          <div className="mt-[2%] lg:mt-[4%] text-[15px] font-[500] text-black/50">
            <p className="mb-[15px] lg:w-[108%]">
              Do you have any questions, suggestions, or comments? Do you have a
              concern with one of our listings? Just fill out the contact form
              and we will get back to you as soon as we can (typically within
              one business day)
            </p>

            <p className="lg:w-[108%]">
              Do you have any questions, suggestions, or comments? Do you have a
              concern with one of our listings? Just fill out the contact form
              and we will get back to you as soon as we can (typically within
              one business day)
