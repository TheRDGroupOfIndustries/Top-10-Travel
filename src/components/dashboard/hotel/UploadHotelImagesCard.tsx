...
const UploadHotelImagesCard = ({
  ...
  const { mutate, isPending } = useMutation(deleteHotelImage);
      ...
      <CardHeader>
        <CardTitle>
          ...
          >
            ...
            <DialogContent>
              <DialogHeader>
                <DialogTitle>Add a company Image</DialogTitle>
                <DialogDescription>
...
const UploadAgencyImages = ({ companyId }: { companyId: string }) => {
  ...
  const { mutate, isPending } = useMutation(uploadHotelImages);
...
export default UploadHotelImagesCard;
